...
export class PokemonSprite extends Sprite {
	...
	protected static statusTable: { [id: string]: [string, 'good' | 'bad' | 'neutral'] | null | string } = {
		...
		chronocatalystatk: ['Chrono Catalyst: Atk', 'good'],
		chronocatalystdef: ['Chrono Catalyst: Def', 'good'],
		chronocatalystspa: ['Chrono Catalyst: SpA', 'good'],
		chronocatalystspd: ['Chrono Catalyst: SpD', 'good'],
		chronocatalystspe: ['Chrono Catalyst: Spe', 'good'],
