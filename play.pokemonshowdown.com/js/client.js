...
(function ($) {
	...
	this.ProxyPopup = Popup.extend({
		...
		initialize: function (data) {
			...
			var buf = '<form>';
			buf += '<p>Because we don\'t have a login server, we need to do this manually:</p>';
			...
			buf += '<p>(If it says "loggedin:false" it means you have to log in/sign up on <a href="https://play.pokemonshowdown.com" target="_blank">Pokemon Showdown\'s official server</a> first, then refresh the page and paste the information from above to the box bellow.)</p>';
